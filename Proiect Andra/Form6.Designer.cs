...
namespace Proiect_Andra
{
	partial class Form6
	{
		...
		private void InitializeComponent()
		{
			...
			this.groupBox1.Text = "1.Ce a fost Freddie Mercury?";
			// 
			// radioButton1
			// 
			...
			this.radioButton2.Text = "vocalist";
			...
			this.radioButton3.Text = "presedintele Frantei";
			...
			this.button1.Size = new System.Drawing.Size(394, 211);
			...
			this.groupBox2.Size = new System.Drawing.Size(388, 227);
			this.groupBox2.TabIndex = 4;
			this.groupBox2.TabStop = false;
			this.groupBox2.Text = "2. Cati membrii avea formatia Queen?";
			// 
			// radioButton4
			// 
			...
			this.groupBox3.Text = "3. Cine a fost bateristul formatiei Queen?";
			// 
			// radioButton7
			// 
